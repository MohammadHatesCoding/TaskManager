        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssignmentEmployee_Assignment_AssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Company_Attachment_LogoId",
                        column: x => x.LogoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Describtion = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentEmployee_AssignmentId_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectEmployee_ProjectId_EmployeeId",
                table: "ProjectEmployee",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AssignmentEmployee_Employee_EmployeeId",
                table: "AssignmentEmployee",
                column: "EmployeeId",
                principalTable: "Employee",
                principalColumn: "Id",
